    ...
    <div className="max-w-4xl mx-auto py-8">
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Based on your goal{businessGoal ? `: "${businessGoal}"` : ''}, 
          we've generated strategic design paths. Explore each option and select the one that best aligns with your needs.
        </p>
      </motion.div>
